...
public class ToggleController : MonoBehaviour 
{
	...
	public Color onColorHd;
	public Color offColorHd;
	public Image toggleBgImage;
	public Image handlerBgImage;
	...
	void Start()
	{
		if(isOn)
		{
			...
			handlerBgImage.color = onColorHd;
		...
		else
		{
			...
			handlerBgImage.color = offColorHd;
	...
	public void Toggle(bool toggleStatus)
	{
		...
		if(toggleStatus)
		{
			...
			handlerBgImage.color = SmoothColor(onColorHd,offColorHd);
		...
		else 
		{
			...
			handlerBgImage.color = SmoothColor(offColorHd, onColorHd);
